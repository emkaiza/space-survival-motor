...
![Space Survival Engine](docs/space-survival-engine.svg)
...
class Jugador{
  +Jugador(String nombre, int x, int y, int ancho, int alto, int vida, char imagen)
  +actualizar()
...
class Enemigo{
  ...
  +Enemigo(String nombre, int x, int y, int ancho, int alto, int vida, char imagen)
  +actualizar()
  +getEstado() String
  +setEstado(String nuevo)
  +actualizarComportamiento(Jugador jugador)
  +atacarJugador(Jugador jugador)
}
...
class MotorJuego{
  ...
  +eliminarEntidad(EntidadVideojuego entidad)
  +actualizar()
  +getEstado() String
...
class GestorEntradas{
  +moverJugador(Jugador jugador, int dx, int dy)
  +moverJugador(Jugador jugador, String direccion)
  +accionJugador(Jugador jugador, Enemigo enemigo, MotorJuego motor)
}
...
GestorEntradas --> Enemigo : interactua
Main --> MotorJuego
Main --> GestorEntradas
Main --> Jugador
Main --> Enemigo
